        ...
        return (
          ...
          >
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              ...
              <Input
                label="Company Email"
                value="info@smartchainnexus.com"
              />
            ...
            <div className="mt-8 flex flex-col gap-4 rounded-2xl border border-slate-200 bg-slate-50 p-6 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Create a secure snapshot of your current
                  SmartChain Nexus data.
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
              {integrations.map((integration) => (
                ...
                >
                  ...
                  <button
                    type="button"
                    className="mt-6 w-full rounded-xl border border-slate-200 py-3 text-sm font-semibold text-slate-700 transition hover:bg-slate-50"
                  >
          ...
          >
            <div className="rounded-3xl bg-gradient-to-br from-slate-900 via-slate-800 to-blue-900 p-8 text-white">
              ...
              <p className="mt-3 max-w-2xl text-slate-300">
                An intelligent supply chain management and
                analytics platform designed to connect
          ...
          <div className="flex flex-col justify-between gap-5 md:flex-row md:items-center">
            <div>
              ...
              <p className="mt-2 text-sm text-slate-500 md:text-base">
                Manage your SmartChain Nexus workspace,
                users, security and integrations.
              </p>
            </div>
...
function ActionButtons() {
  return (
    <div className="mt-8 flex justify-end gap-3 border-t border-slate-100 pt-6">
      ...
      <button
        type="button"
        className="rounded-xl bg-blue-600 px-6 py-3 text-sm font-bold text-white shadow-lg shadow-blue-600/20 hover:bg-blue-700"
      >
        Save Changes
      </button>
    </div>
...
function ThemeOption({
  ...
  return (
    ...
    >
      <div
        className={`h-20 rounded-xl ${preview}`}
      />
